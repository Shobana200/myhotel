...
import StarRating from '../compontents/StarRating';
    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col md:flex-row items-start md:items-center md:justify-center gap-2'>
            <h1 className='text-3xl md:text-4xl font-playfair'> 
                {room.hotelName}<span className='font-inter text-sm'>({room.roomType})</span></h1>
        ...
        {/* Room Address  */}
        <div className='flex items-center md:justify-center gap-1 text-gray-500 mt-2'>
            <img src={assets.locationIcon} alt="location-icon" />
            <span>{room.hotelAddress}</span>
        </div>

        {/* Room Images  */}
        <div className='flex flex-col items-center justify-center lg:flex-row mt-6 gap-6'>
        ...
        <div className='flex flex-col md:flex-row md:justify-between mt-10'>
            <div className='flex flex-col'>
                <h1 className='text-3xl md:text-4xl font-playfair'>Experience Luxury Like Never
                     Before </h1>
        ...
        <form className='flex flex-col md:flex-row items-start md:items-center justify-between
            ...
            <button type='submit' className='bg-primary hover:bg-blue-500 active:scale-95 
            transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-25 py-3
            md:py-4 text-base cursor-pointer'> Check Availability
            </button>
        </form>
        ...
        {/* <div>
            <p className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'> Guests will be allocated on the ground floor according to availability.You get a
                 comfortable Two Bedroom apartment has a true city feeling. The price quoted is for
                  two guests, at the guest slot please mark the number of guests to get the exact
                   price for groups. The Guests will be allocated ground floor according to 
                   availability. You get the comfortable two bedroom apartment that has a true 
                   city feeling.
            </p>
        </div>
        <div> */}
