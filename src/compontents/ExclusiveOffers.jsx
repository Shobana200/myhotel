...
const ExclusiveOffers = () => {
  return (
    <div className='flex flex-col items-center px-6 pt-20 pb-30 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-12 gap-6 '>
              {exclusiveOffers.map((item)=> (
                <div key={item._id} style={{backgroundImage:`url(${item.image})`}} className='group relative flex flex-col items-start 
                ...
                <div>
                    ...
                    <p className='text-xs text-white/70 mt-3 mb-5'> Expires {item.expiryDate}</p>
                </div>   
