...
const Navbar = () => {
    const navLinks = [
        { name: 'Home', path: '/myhotel' },
        { name: 'Hotels', path: '/myhotel/rooms' },
            ...
            <nav className={`fixed top-0 left-0 w-full flex items-center justify-between px-4
             ...
             "py-4 md:py-6"}`}>
                ...
                <div className="hidden md:flex items-center gap-4 lg:gap-8">
                    ...
                    <button onClick={()=>navigate('/owner')} className={`border px-4 py-1 text-sm 
                        font-light rounded-full cursor-pointer ${isScrolled ? 'text-black' : 
                ...
                {user && <UserButton>
                    ...
                    alt="menuicon" className={`${isScrolled && "invert" } h-4 `}/>
                </div>
